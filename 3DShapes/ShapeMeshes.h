...
private:
	...
	struct GLMesh
	{
		...
		GLuint vbos[2] = { 0, 0 };     // Handles for the vertex buffer objects
	...
	void UnloadMesh(GLMesh mesh); // unloads specific GLMesh

public:
	void UnloadAllMeshes(); // unloads all GLMeshes in this class
