...
//  UnloadMesh()
//  
//  Deletes the vao and vbos buffers of the GLMesh passed in.
// 
//  AUTHOR: Samuel Williamson
//  FOR:
//    CS-499 (Category: Software Design and Engineering) (5/31/2026)
///////////////////////////////////////////////////
void ShapeMeshes::UnloadMesh(GLMesh mesh)
{
...
//  UnloadAllMeshes()
//  
//  Unloads all GLMeshes already loaded, regardless of load status.
// 
//  AUTHOR: Samuel Williamson
//  FOR:
//    CS-499 (Category: Software Design and Engineering) (5/31/2026)
///////////////////////////////////////////////////
void ShapeMeshes::UnloadAllMeshes()
{
	UnloadMesh(m_BoxMesh);
	UnloadMesh(m_ConeMesh);
	UnloadMesh(m_CylinderMesh);
	UnloadMesh(m_PlaneMesh);
	UnloadMesh(m_PrismMesh);
	UnloadMesh(m_Pyramid3Mesh);
	UnloadMesh(m_Pyramid4Mesh);
	UnloadMesh(m_SphereMesh);
	UnloadMesh(m_TaperedCylinderMesh);
	UnloadMesh(m_TorusMesh);
}
